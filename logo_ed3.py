...
canvas4 = Canvas(frame, height=500, width=590)
back_img=ImageTk.PhotoImage(Image.open("final1600600.png"))
...
instbut.place(x=215,y=80)
but.place(x=110,y=40)
but1.place(x=320,y=40)
cbut_music.place(x=530,y=3)
